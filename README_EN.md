...
├── templates/              # Phantom Deck slide template library
├── tests/                  
│   ├── xingji/             # "Qian Xuesen Trajectory" complete animation example & static assets
│   └── Solar_System_Cinematic/  # 🪐 Solar System Cinematic Phantom Deck example (by Claude Opus 4)
...
### 🪐 Solar System Cinematic — Phantom Deck Example

> A 12-page cinematic interactive slideshow fully auto-generated by **Claude Opus 4**, showcasing the complete capabilities of the Phantom Deck engine.
...
- 🌞 **FBM Shader Sun** — 5-layer fractal noise simulating coronal ejections, real-time dynamic rendering
- 🪐 **14-Moon Satellite System** — Each moon with unique procedural textures (Io volcanic yellow, Europa ice cracks, Titan orange haze...)
- ☄️ **Halley's Comet** — 3000-particle tail + elliptical orbit animation
- 🎨 **SVG Cinematic Title Animation** — 3-layer stacked stroke animation + bevel 3D filter + glow layer
- ✏️ **WYSIWYG Double-Click Editing** — What You See Is What You Get, double-click any text to edit, auto-saved to localStorage
- 🔭 **Real Astronomical Data** — Log-scaled planet proportions, visible orbit lines, axial tilt (Uranus 97.77°)
- 💡 **Multi-Layer Lighting** — PointLight sun + AmbientLight + DirectionalLight fill + emissive self-illumination
